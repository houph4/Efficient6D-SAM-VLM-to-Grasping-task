...
def test_func(model, dataloder, save_path):
    ...
    print("Average inference time per batch: {:.4f} seconds".format(average_inference_time))
    print("Average inference speed: {:.4f} FPS".format(1.0 / average_inference_time))
...
def draw_box_to_image(data, result,  data_name, img_id):
    ...
    out_dir = "/media/midea2/787d7b0f-26f9-4255-a892-756df38d1c15/home/midea1/Desktop/IST-Net/log/ist_net_default/img1"
